...
** 功能:获取时间
******************************************************************************/
uint16 GetSystemTime(uint8 SetTime)
{
	static uint16 Systemtime;
	

	Systemtime =TimeCount[SetTime];
...
** 功能:获取时间
******************************************************************************/
uint16 GetCurrentTime(uint8 SetTime,uint16 GetStartTime)
{
	static uint16 Currenttime,Tmp;
	

	Currenttime =GetSystemTime(SetTime);
	
	Tmp=abs(Currenttime -GetStartTime);
	return(Tmp); 
}
